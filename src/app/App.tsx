    ...
    <div className="min-h-screen bg-background overflow-x-hidden" style={{ fontFamily: "'Poppins', sans-serif" }}>
      <nav className="sticky top-0 z-40 bg-background/90 backdrop-blur-md border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <img src="https://drive.google.com/file/d/1Yd_gF-XFYBolssa-4ubs27n6KMYwkCv8/view?usp=drivesdk" alt="Pruta Academy" className="h-9 w-9 rounded-xl object-contain" />
      ...
      <footer className="border-t border-border">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <img src="https://drive.google.com/file/d/1Yd_gF-XFYBolssa-4ubs27n6KMYwkCv8/view?usp=drivesdk" alt="Pruta Academy" className="h-8 w-8 rounded-xl object-contain" />
      ...
      <div className="hidden lg:block relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-10 text-white">
          <div className="flex items-center gap-2.5 mb-8">
            <img src="https://drive.google.com/file/d/1Yd_gF-XFYBolssa-4ubs27n6KMYwkCv8/view?usp=drivesdk" alt="Pruta Academy" className="h-9 w-9 rounded-xl object-contain bg-white/10 p-1" />
